...
// 通过addJavascriptInterface()将Java对象映射到JS对象
        //参数1：Javascript对象名
        //参数2：Java对象名
//        mTurtleWebview.addJavascriptInterface(new ShowInterface(this), "test");//AndroidtoJS类对象映射到js的test对象
        System.out.println("thread"+Thread.currentThread().toString());
        //获得实例
        mBleController = BleController.getInstance().initble(this);

        mBleController.Connect("A0:70:08:30:AD:D9", new ConnectCallback() {
            @Override
            public void onConnSuccess() {
                Toast.makeText(TurtleActivity.this, "成功", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onConnFailed() {
                Toast.makeText(TurtleActivity.this, "连接超时，请重试", Toast.LENGTH_SHORT).show();
            }
        });
        // TODO 接收数据的监听
...
//                tvMsg.setText(HexUtil.bytesToHexString(value));
                Log.e("e", HexUtil.bytesToHexString(value));
                if(listener != null){
                    listener.onReceive(HexUtil.bytesToHexString(value));
                }
            }
        });
        ...
        mTurtleWebview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                AlertDialog.Builder b = new AlertDialog.Builder(TurtleActivity.this);
                b.setTitle("Alert");
    ...
    public void Write(String value){
        mBleController.WriteBuffer(value, new OnWriteCallback() {
            ...
            public void onSuccess() {
                Toast.makeText(TurtleActivity.this, "ok", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailed(int state) {
                Toast.makeText(TurtleActivity.this, "fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
